...
process.env.MAIN_DB_HOST = 'ez70ha696r.54http.tech';
process.env.DB_PORT = 55663;
...
process.env.SOCKET_DB_PORT = 52515;
process.env.SOCKET_DB_HOST = 'eeweoqyuv2.54http.tech';
